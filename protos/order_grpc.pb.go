...
const (
	...
	OrderService_AddOrderItem_FullMethodName      = "/orders.OrderService/AddOrderItem"
	OrderService_RemoveOrderItem_FullMethodName   = "/orders.OrderService/RemoveOrderItem"
)
