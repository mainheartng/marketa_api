...
const (
	...
	CustomerService_AddCustomerAddress_FullMethodName    = "/customer.CustomerService/AddCustomerAddress"
	CustomerService_UpdateCustomerAddress_FullMethodName = "/customer.CustomerService/UpdateCustomerAddress"
	CustomerService_DeleteCustomerAddress_FullMethodName = "/customer.CustomerService/DeleteCustomerAddress"
)
...
func (c *customerServiceClient) AddCustomerAddress(ctx context.Context, in *AddCustomerAddressRequest, opts ...grpc.CallOption) (*AddCustomerAddressResponse, error) {
	...
	err := c.cc.Invoke(ctx, CustomerService_AddCustomerAddress_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *customerServiceClient) DeleteCustomerAddress(ctx context.Context, in *DeleteCustomerAddressRequest, opts ...grpc.CallOption) (*DeleteCustomerAddressResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedCustomerServiceServer) AddCustomerAddress(context.Context, *AddCustomerAddressRequest) (*AddCustomerAddressResponse, error) {
...
func (UnimplementedCustomerServiceServer) DeleteCustomerAddress(context.Context, *DeleteCustomerAddressRequest) (*DeleteCustomerAddressResponse, error) {
...
func _CustomerService_AddCustomerAddress_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CustomerService_AddCustomerAddress_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
